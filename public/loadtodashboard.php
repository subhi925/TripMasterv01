...
try {
  ...
  while ($r = mysqli_fetch_assoc($res)) {
    // أضمن إرجاع JSON fields كنصوص سليمة لما الـ React يعمل JSON.parse(...)
    ...
    $out[] = [
      ...
      // هذه الحقول تُعاد كنص JSON (بالضبط كما يريد الفرونت)
